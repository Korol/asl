...
$PHPTHUMB_CONFIG['high_security_password']      = '4"93:2/R5@sUhjBSd=Kx';      // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
...
//$PHPTHUMB_CONFIG['mysql_query'] = 'SELECT Image FROM assol_images WHERE `id` = '.mysql_escape_string(@$_GET['id']);
